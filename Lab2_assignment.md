...
``` r
acs_vars <- c("B18135_014", #Estimate!!Total:!!19 to 64 years:!!With a disability
              "B18135_015" #Estimate!!Total:!!19 to 64 years:!!With a disability:!!With health insurance coverage:"
             )

myTracts <- c("42101007700", "42101007800")
...
acsTractsPHL.2019.sf <- get_acs(geography = "tract",
  ...
  rename (total_disabled.2019 = B18135_014E,
          total_disabled_insured.2019 = B18135_015E) %>%
  mutate(Neighborhood = ifelse(GEOID %in% myTracts,
                               "Cedar Park",
                               "REST OF PHILADELPHIA")) %>%
  mutate(percent_insured.2019 = 100*(total_disabled_insured.2019/total_disabled.2019))
```

...
ggplot()+
  ...
  geom_sf(data = acsTractsPHL.2019.sf, aes(fill = percent_insured.2019),
          color = "transparent")+
  ...
  labs(
   title = "Percent of Disabled Adults with Health Insurance",
    subtitle = "Adults between 19 and 64 with a disability",
    caption = "2019 ACS Data")
